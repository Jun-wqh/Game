...
public class BossPlane1 extends FlyingObject {
	...
	/**发射子弹*/
	public BossBullet1[] Boss_shoot() {
		int xStep = this.width/5;
		int yStep = 20+this.height;
		if(life>0) {
		BossBullet1 bos[] = new BossBullet1[3];  
		bos[0] = new BossBullet1(this.x+1*xStep, y+yStep,0); 
		bos[1] = new BossBullet1(this.x+3*xStep, y+yStep,0); 
		bos[2] = new BossBullet1(this.x+2*xStep, y+yStep,0); 
