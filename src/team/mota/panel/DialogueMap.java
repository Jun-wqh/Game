...
public class DialogueMap {
    ...
    static {
        dialogueMessageMap.put(MotaMap.n + "2", "老者：。");
        ...
        dialogueMessageMap.put(MotaMap.m + "2", "奸商：。");
        ...
        dialogueMessageMap.put(MotaMap.l + "10-1", "小偷：嘿！我们又见面了！非常看些你打败了此区域的头目。我正苦恼于如何到更高的楼层，现在我终于可以上去了，我听说银盾在11楼，银剑在17楼，这消息不知道对你是否有用。");
    }
